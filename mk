...
# spring ------------------------------->>>
    ...
    wget http://www.vonbros.com/x7_cache/pika-0.9.5.tar.gz -O $CURWD/cache/pip/pika-0.9.5.tar.gz
    tar xzf $CURWD/cache/pip/pika-0.9.5.tar.gz -C $CURWD/cache/pip/
    rm -f $CURWD/cache/pip/pika-0.9.5.tar.gz
    wget http://www.vonbros.com/x7_cache/passlib-1.5.3.tar.gz -O $CURWD/cache/pip/passlib-1.5.3.tar.gz
    tar xzf $CURWD/cache/pip/passlib-1.5.3.tar.gz -C $CURWD/cache/pip/
    rm -f $CURWD/cache/pip/passlib-1.5.3.tar.gz
    wget http://www.vonbros.com/x7_cache/django-nose-selenium-0.7.3.tar.gz -O $CURWD/cache/pip/django-nose-selenium-0.7.3.tar.gz
